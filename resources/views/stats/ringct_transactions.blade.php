...
<div class="row">
  <div class="col-xs-12 col-lg-12 text-left">
    <h5><span class="page-header large"><i class="fa fa-envelope-o"></i>&nbsp;rincCT transactions (excluding coinbase)</span></h5>
  </div>
  <!-- /.col-lg-22 --> 
</div> <!-- /.row -->
    ...
    <div class="panel panel-default panel-table">
      <div class="panel-heading">
        <div class="row ">
          ...
          <div class="col-xs-3 col-sm-2 col-md-3">date</div>
          <div class="col-xs-3 col-sm-2 col-md-2">non ringct</div>
          <div class="col-xs-3 col-sm-2 col-md-2">ringct</div>
          <div class="col-xs-3 col-sm-2 col-md-2">ratio</div>
